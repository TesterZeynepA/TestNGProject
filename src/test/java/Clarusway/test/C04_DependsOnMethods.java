...
public class C04_DependsOnMethods {
    ...
    @Test
    void startCar(){
        System.out.println("araba calistir"); //bu test bağımsız
    }
    ...
    @Test(dependsOnMethods = {"driveCar"})//bu testin çalışması driveCar testinin hatasız çalışmasına bağlı
    void parkCar(){
        System.out.println("araba park halinde");
    }
    /*
    araba calistir
    araba sur
