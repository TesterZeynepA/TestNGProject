...
public class C21_ParallelTest {
    ...
    public void test01(){
        ...
        System.out.println("test1 icin calisan thread - " + id);
    }
    @Test
    public void test02(){
        long id = Thread.currentThread().getId();
        System.out.println("test2 icin calisan thread - " + id);
    }
    @Test
    public void test03(){
        long id = Thread.currentThread().getId();
    ...
    public void test05(){
        long id = Thread.currentThread().getId();
        System.out.println("test5 icin calisan thread - " + id);
    }
    @Test
    public void test06(){
        long id = Thread.currentThread().getId();
        System.out.println("test6 icin calisan thread - " + id);
    }
    @Test
    public void test07(){
        long id = Thread.currentThread().getId();
        System.out.println("test7 icin calisan thread - " + id);
    }
    @Test
    public void test08(){
        long id = Thread.currentThread().getId();
        System.out.println("test8 icin calisan thread - " + id);
    }
    @Test
    public void test09(){
        long id = Thread.currentThread().getId();
        System.out.println("test9 icin calisan thread - " + id);
    }
}
